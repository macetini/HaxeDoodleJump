...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DoodleJump", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("DoodleJump", null, 480, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "25";
		app.meta["company"] = "Marko Cettina";
		app.meta["file"] = "DoodleJump";
		app.meta["name"] = "DoodleJump";
		app.meta["packageName"] = "DoodleJump";
